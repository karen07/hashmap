...
typedef struct array_hashmap {
    ...
    int32_t (*cmp_func)(const void*, const void*);
    int32_t iter_flag;
...
int32_t array_hashmap_add_elem(const array_hashmap_t* map_struct, const void* add_elem, void* res_elem);
int32_t array_hashmap_repl_elem(const array_hashmap_t* map_struct, const void* repl_elem, void* res_elem);
